...
gcc -g main.c  Gbuffer_VS.o LD_Math.o LD_Collision_2D.o LD_OES2_GLFW3.o LD_C_Chrono.o LD_Navi_2D.o LD_STL.o LD_Polygon_Extract_3D.o NasmMath.o Gbuffer_FS.o  -lluajit-5.1 -lm -lglfw -lGL -lpthread -no-pie -o Phobos-Game
