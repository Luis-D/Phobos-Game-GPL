...
gcc -g -c libLDCC/Time/LD_C_Chrono.c		    -o tmp/LD_C_Chrono.o
...
gcc -g -c libLDCC/Extern/LD_Math.c		    -o tmp/LD_Math.o
...
nasm -f ELF64 -g -F dwarf -i libLDCC/Boring-NASM-Code/x86-64/Math/ libLDCC/Boring-NASM-Code/x86-64/Math/NasmGeometry64.asm -o tmp/NasmGeometry.o

cd tmp

gcc -g main.o NasmGeometry.o Gbuffer_VS.o LD_Math.o LD_Collision_2D.o LD_OES2_GLFW3.o LD_C_Chrono.o LD_Navi_2D.o LD_STL.o LD_Polygon_Extract_3D.o Gbuffer_FS.o  -lluajit-5.1 -lm -lglfw -lGL -lpthread -fno-omit-frame-pointer -no-pie -o Phobos-Game
